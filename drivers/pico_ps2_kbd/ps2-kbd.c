...
/* Pins are board-specific. PICO-56 board config supplies them via -D. */
#ifndef PS2_DATA_GPIO
#define PS2_DATA_GPIO  14
#endif
#ifndef PS2_CLOCK_GPIO
#define PS2_CLOCK_GPIO 15
#endif

/* No interrupts.h on this build target. Stub the HBC-56 hooks. */
#define raiseInterrupt(x)   ((void)0)
#define releaseInterrupt(x) ((void)0)
