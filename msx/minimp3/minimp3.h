...
/* External scratch buffer - defined in main.c, points into mainram to save RAM */
extern mp3dec_scratch_t *mp3_scratch_ptr;
...
int mp3dec_decode_frame(mp3dec_t *dec, const uint8_t *mp3, int mp3_bytes, mp3d_sample_t *pcm, mp3dec_frame_info_t *info)
{
    ...
    const uint8_t *hdr;
    bs_t bs_frame[1];
    mp3dec_scratch_t *scratch = mp3_scratch_ptr;
